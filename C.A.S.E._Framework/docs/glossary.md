...
| **宏觀層 / 指揮所** | Macro Layer / Strategic Planning Layer | 智囊團，負責看全局、出計畫、訂結案標準，但不碰具體案件資料 | Layer 2；雲端前沿 AI（Claude、Gemini、GPT 等各大廠旗艦模型，以當下最強者為準）；生成 Roadmap 與 Task Packages |
